 ...
 *
 * <p>Called by the orchestrator to consult the LLM. Receives all necessary context
 * (config, tools, resolved variables, conversation history) and returns the LLM's
 * response plus the updated conversation history.
 */
