...
class AgentOrchestrationJobHandlerTest {
        ...
        @Mock
        private LlmOrchestrationService llmOrchestrationService;
        @Mock
        ...
        class EntryPath {
                ...
                void execute_callsLlmAndDispatchesTools() {
                        ...
                        LlmResponse response = new LlmResponse("I'll check task A", toolCalls,
                                        updatedHistory);
                        when(llmOrchestrationService.call(eq(agentConfig), eq(toolCatalogue),
                        ...
                        verify(llmOrchestrationService).call(eq(agentConfig), eq(toolCatalogue),
